...
export class AppConfigService {
    ...
    public get cryptoAlgorithm(): string {
        return this.configService.get<string>('CRYPTO_ALGORITHM');
    }

    public get cryptoSecret(): string {
        return this.configService.get<string>('CRYPTO_SECRET');
    }

    public get cryptoIV(): string {
        return this.configService.get<string>('CRYPTO_IV');
    }
